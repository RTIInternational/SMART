...
export default function AnnotateCard({ card, labels, onSelectLabel, readonly = false, onSkip = null, onDiscard = null, onUnassign = null, showAdjudicate = true, suggestions = true, modifyMetadataValues = null }) {
    return (
        <div className="cardface clearfix">
            <div className="cardface-datacard">
                <CardData card={card} onSkip={onSkip} onUnassign={onUnassign} showAdjudicate={showAdjudicate} modifyMetadataValues={modifyMetadataValues} />
