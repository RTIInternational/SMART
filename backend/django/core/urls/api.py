...
urlpatterns = [
    ...
    url(r'^discard_data/(?P<pk>\d+)/$', api.discard_data),
    url(r'^restore_data/(?P<pk>\d+)/$', api.restore_data),
    url(r'^recycle_bin_table/(?P<pk>\d+)/$', api.recycle_bin_table),
    ...
    url(r'^download_model/(?P<pk>\d+)/$', api.download_model),
