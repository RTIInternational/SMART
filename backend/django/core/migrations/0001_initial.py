...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('pickle_path', models.FilePathField(path='/Users/jnance/projects/smart/django/smart/models')),
                ('predictions', models.ManyToManyField(related_name='models', through='core.DataPrediction', to='core.Data')),
            ],
        ),
        migrations.CreateModel(
            name='Project',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('data', models.ManyToManyField(related_name='queues', through='core.DataQueue', to='core.Data')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('labels', models.ManyToManyField(related_name='labelers', through='core.DataLabel', to='core.Data')),
            ],
        ),
        migrations.AddField(
            model_name='queue',
        ...
        migrations.AddField(
            ...
            name='queue',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Queue'),
        ),
        migrations.AddField(
